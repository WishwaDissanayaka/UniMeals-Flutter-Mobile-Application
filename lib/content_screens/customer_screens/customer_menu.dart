...
import 'package:passdata/content_screens/customer_screens/customer_ricecurry.dart';
...
class CustomerMenuView extends StatelessWidget {
    ...
    return Container(
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage('assets/backggg.jpg'), // Your background image
  ...
  Widget _buildCustomerMenuButton(
    IconData iconData,
    String label,
    VoidCallback onTap,
  ) {
